...
- 筛选条件：{{filters}}
- 合同笔数：{{totalContracts}}
- 贷款余额：{{totalLoanBalanceFormatted}}
- 合同金额：{{totalContractAmountFormatted}}

## 二、整体风险分类分布

全样本共 **{{totalContracts}}** 笔信贷合同，贷款余额合计 **{{totalLoanBalanceFormatted}}**{{contractAmountSummary}}。风险分类分布如下：
